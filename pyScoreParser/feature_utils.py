...
def composer_name_to_vec(composer_name):
    ...
    # composer name for emotionDataset
    composer_name_list = ['Bach', 'Beethoven', 'Chopin', 'Clementi', 'Mozart', 'Schumann', 'Schubert', 'Debussy', 
                          'Kuhlau', 'Bartok', 'Mendelssohn', 'Liszt', 'Rachmaninoff', 'Tchaikovsky', 'Mompou',
                          'Prokofiev']
